              ...
              <div className=" h-full grid grid-cols-2 gap-1 xl:gap-2 grid-rows-2">
                <div className="bg-[#f0f3f6] rounded-lg flex flex-row w-full h-full justify-center items-center">
                  <span className=" w-2/5 h-full flex justify-center items-center">
                    <i className="far fa-eye bg-[#345af4] p-2 text-white text-base 3xl:text-3xl 3xl:p-3 rounded-full"></i>
                  </span>
                  <div className="w-3/5 flex flex-col">
                    <span className="text-sm 3xl:text-xl text-[#7c7c7c]">
                      Open
                    </span>
                    <span className="text-xl 3xl:text-4xl font-bold">14</span>
                  </div>
                </div>
                <div className="bg-[#f0f3f6] rounded-lg flex flex-row w-full h-full justify-center items-center">
                  <span className=" w-2/5 h-full flex justify-center items-center">
                    <i className="fas fa-sync bg-[#292659] p-2 text-white text-base rounded-full 3xl:text-3xl 3xl:p-3"></i>
                  </span>
                  <div className="w-3/5 flex flex-col">
                    <span className="text-sm 3xl:text-xl text-[#7c7c7c]">
                      In Progress
                    </span>
                    <span className="text-xl font-bold 3xl:text-4xl">14</span>
                  </div>
                </div>
                <div className="bg-[#f0f3f6] rounded-lg flex flex-row w-full h-full justify-center items-center">
                  <span className=" w-2/5 h-full flex justify-center items-center">
                    <i className="bx bxs-bell-ring bg-[#f2a516] p-2 text-white text-base rounded-full 3xl:text-3xl 3xl:p-3"></i>
                  </span>
                  <div className="w-3/5 flex flex-col">
                    <span className="text-sm 3xl:text-xl text-[#7c7c7c]">
                      Open not response
                    </span>
                    <span className="text-xl 3xl:text-4xl font-bold text-[#f42828]">
                      9
                    </span>
                  </div>
                </div>
                <div className="bg-[#f0f3f6] rounded-lg flex flex-row w-full h-full justify-center items-center">
                  <span className=" w-2/5 h-full flex justify-center items-center">
                    <i className="fas fa-check bg-[#d1503f] p-2 text-white text-base rounded-full 3xl:text-3xl 3xl:p-3"></i>
                  </span>
                  <div className="w-3/5 flex flex-col">
                    <span className="text-sm 3xl:text-xl text-[#7c7c7c]">
                      Resolved
                    </span>
                    <span className="text-xl 3xl:text-4xl font-bold">9</span>
                  </div>
                </div>
              </div>
            </div>
                ...
                <table className=" w-full">
                  <thead>
                    <tr className="text-left">
                      <th className="font-semibold px-4 py-1 text-xs 3xl:text-lg">
                        No Redmine
                      </th>
                      <th className="font-semibold px-4 py-1 text-xs 3xl:text-lg">
                        Assign Date
